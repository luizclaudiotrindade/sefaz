			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img
							src="https://www.contabilidadenatv.com.br/wp-content/uploads/2015/06/sefazpe.jpg"
					...
					<form action="efetuarLogin" method="post"> 
						<div class="input-group mb-3">
							...
							<input type="text" name="email" class="form-control input_user"
								value="${usuario.email}"  placeholder="Email" required>
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="password" name="senha" class="form-control input_pass"
